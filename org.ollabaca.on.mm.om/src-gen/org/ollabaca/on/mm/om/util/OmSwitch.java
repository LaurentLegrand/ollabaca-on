/**
 */
package org.ollabaca.on.mm.om.util;
...
public class OmSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case OmPackage.OM_ELEMENT:
      {
        OmElement omElement = (OmElement)theEObject;
        T result = caseOmElement(omElement);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case OmPackage.QUANTITY_KIND:
      {
        QuantityKind quantityKind = (QuantityKind)theEObject;
        T result = caseQuantityKind(quantityKind);
        if (result == null) result = caseDataType(quantityKind);
        if (result == null) result = caseOmElement(quantityKind);
        if (result == null) result = caseClassifier(quantityKind);
        if (result == null) result = caseNamespace(quantityKind);
        if (result == null) result = caseRedefinableElement(quantityKind);
        if (result == null) result = caseType(quantityKind);
        if (result == null) result = caseTemplateableElement(quantityKind);
        if (result == null) result = casePackageableElement(quantityKind);
        if (result == null) result = caseNamedElement(quantityKind);
        if (result == null) result = caseParameterableElement(quantityKind);
        if (result == null) result = caseElement(quantityKind);
        if (result == null) result = caseEModelElement(quantityKind);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case OmPackage.DIMENSION:
      {
      ...
      case OmPackage.UNIT:
      {
        ...
        if (result == null) result = caseOmElement(unit);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case OmPackage.OBSERAVTION:
      {
        Obseravtion obseravtion = (Obseravtion)theEObject;
        T result = caseObseravtion(obseravtion);
        if (result == null) result = caseOmElement(obseravtion);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case OmPackage.MEASURE:
      {
        Measure measure = (Measure)theEObject;
        T result = caseMeasure(measure);
        if (result == null) result = caseOmElement(measure);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case OmPackage.DATA_SET:
      {
   ...
   * @generated
   */
  public T caseOmElement(OmElement object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Obseravtion</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Obseravtion</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseObseravtion(Obseravtion object)
  {
    return null;
  }
