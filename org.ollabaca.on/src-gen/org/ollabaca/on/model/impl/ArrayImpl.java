 ...
 * <ul>
 *   <li>{@link org.ollabaca.on.model.impl.ArrayImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayImpl extends ValueImpl implements Array
{
  ...
  public EList<Value> getValue()
  {
    if (value == null)
    {
      value = new EObjectContainmentEList<Value>(Value.class, this, ModelPackage.ARRAY__VALUE);
    }
    return value;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ModelPackage.ARRAY__VALUE:
