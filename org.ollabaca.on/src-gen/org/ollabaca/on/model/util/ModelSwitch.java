  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case ModelPackage.BOOLEAN_VALUE:
      {
        ...
        if (result == null) result = caseLiteral(booleanValue);
      ...
      case ModelPackage.NULL_VALUE:
      {
        ...
        if (result == null) result = caseLiteral(nullValue);
      ...
      case ModelPackage.NUMBER_VALUE:
      {
        ...
        if (result == null) result = caseLiteral(numberValue);
      ...
      case ModelPackage.INSTANCE_REF:
      {
        ...
        if (result == null) result = caseValue(instanceRef);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ModelPackage.ENUM_VALUE:
      {
        ...
        if (result == null) result = caseLiteral(enumValue);
