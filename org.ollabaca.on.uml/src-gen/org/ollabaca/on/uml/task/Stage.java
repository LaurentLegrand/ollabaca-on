 ...
 * <ul>
 *   <li>{@link org.ollabaca.on.uml.task.Stage#getNestedStages <em>Nested Stages</em>}</li>
 *   <li>{@link org.ollabaca.on.uml.task.Stage#getNestingStage <em>Nesting Stage</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.ollabaca.on.uml.task.TaskPackage#getStage()
 * @model
 * @generated
 */
public interface Stage extends NamedElement, TaskElement
{
   ...
   * The list contents are of type {@link org.ollabaca.on.uml.task.Stage}.
   * It is bidirectional and its opposite is '{@link org.ollabaca.on.uml.task.Stage#getNestingStage <em>Nesting Stage</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.ollabaca.on.uml.task.TaskPackage#getStage_NestedStages()
   ...
   * It is bidirectional and its opposite is '{@link org.ollabaca.on.uml.task.Stage#getNestedStages <em>Nested Stages</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.ollabaca.on.uml.task.TaskPackage#getStage_NestingStage()
  ...
  /**
   * Sets the value of the '{@link org.ollabaca.on.uml.task.Stage#getNestingStage <em>Nesting Stage</em>}' container reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
