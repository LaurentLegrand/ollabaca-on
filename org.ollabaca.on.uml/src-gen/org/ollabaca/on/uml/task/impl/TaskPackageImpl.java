...
import org.ollabaca.on.uml.task.Assignment;
import org.ollabaca.on.uml.task.Coordinate;
import org.ollabaca.on.uml.task.Important;
import org.ollabaca.on.uml.task.Note;
import org.ollabaca.on.uml.task.Phase;
import org.ollabaca.on.uml.task.Stage;
import org.ollabaca.on.uml.task.Task;
import org.ollabaca.on.uml.task.TaskElement;
import org.ollabaca.on.uml.task.TaskFactory;
...
public class TaskPackageImpl extends EPackageImpl implements TaskPackage
{
   ...
   * @see org.ollabaca.on.uml.task.TaskPackage#eNS_URI
   * @see #init()
   * @generated
   */
