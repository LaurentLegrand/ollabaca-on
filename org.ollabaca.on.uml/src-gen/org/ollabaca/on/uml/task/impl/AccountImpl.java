...
import org.ollabaca.on.uml.task.TaskElement;
 ...
 * <ul>
 *   <li>{@link org.ollabaca.on.uml.task.impl.AccountImpl#getOwningTemplateParameter <em>Owning Template Parameter</em>}</li>
 *   <li>{@link org.ollabaca.on.uml.task.impl.AccountImpl#getTemplateParameter <em>Template Parameter</em>}</li>
 *   <li>{@link org.ollabaca.on.uml.task.impl.AccountImpl#getNestedAccounts <em>Nested Accounts</em>}</li>
 *   <li>{@link org.ollabaca.on.uml.task.impl.AccountImpl#getNestingAccount <em>Nesting Account</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
