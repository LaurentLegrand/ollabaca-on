...
import org.ollabaca.on.uml.task.Account;
import org.ollabaca.on.uml.task.Phase;
import org.ollabaca.on.uml.task.Task;
 ...
 * <ul>
 *   <li>{@link org.ollabaca.on.uml.task.impl.TaskImpl#getAccount <em>Account</em>}</li>
 *   <li>{@link org.ollabaca.on.uml.task.impl.TaskImpl#getPhase <em>Phase</em>}</li>
 *   <li>{@link org.ollabaca.on.uml.task.impl.TaskImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link org.ollabaca.on.uml.task.impl.TaskImpl#getPerformer <em>Performer</em>}</li>
 *   <li>{@link org.ollabaca.on.uml.task.impl.TaskImpl#getEffort <em>Effort</em>}</li>
 *   <li>{@link org.ollabaca.on.uml.task.impl.TaskImpl#getCompletion <em>Completion</em>}</li>
 *   <li>{@link org.ollabaca.on.uml.task.impl.TaskImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link org.ollabaca.on.uml.task.impl.TaskImpl#getWorks <em>Works</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
