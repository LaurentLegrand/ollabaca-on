 ...
 * <ul>
 *   <li>{@link org.ollabaca.on.uml.task.Account#getNestedAccounts <em>Nested Accounts</em>}</li>
 *   <li>{@link org.ollabaca.on.uml.task.Account#getNestingAccount <em>Nesting Account</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.ollabaca.on.uml.task.TaskPackage#getAccount()
 * @model
 * @generated
 */
public interface Account extends NamedElement, TaskElement, PackageableElement
{
   ...
   * The list contents are of type {@link org.ollabaca.on.uml.task.Account}.
   * It is bidirectional and its opposite is '{@link org.ollabaca.on.uml.task.Account#getNestingAccount <em>Nesting Account</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.ollabaca.on.uml.task.TaskPackage#getAccount_NestedAccounts()
   ...
   * It is bidirectional and its opposite is '{@link org.ollabaca.on.uml.task.Account#getNestedAccounts <em>Nested Accounts</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.ollabaca.on.uml.task.TaskPackage#getAccount_NestingAccount()
  ...
  /**
   * Sets the value of the '{@link org.ollabaca.on.uml.task.Account#getNestingAccount <em>Nesting Account</em>}' container reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
