 ...
 * <ul>
 *   <li>{@link org.ollabaca.on.uml.om.Unit#getQuantityKind <em>Quantity Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.ollabaca.on.uml.om.OmPackage#getUnit()
 * @model
 * @generated
 */
public interface Unit extends OmElement
{
   ...
   * @see org.ollabaca.on.uml.om.OmPackage#getUnit_QuantityKind()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.ollabaca.on.uml.om.Unit#getQuantityKind <em>Quantity Kind</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
