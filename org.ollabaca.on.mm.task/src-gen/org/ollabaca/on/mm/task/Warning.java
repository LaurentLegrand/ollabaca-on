 ...
 * <ul>
 *   <li>{@link org.ollabaca.on.mm.task.Warning#getMitigation <em>Mitigation</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.ollabaca.on.mm.task.TaskPackage#getWarning()
 * @model
 * @generated
 */
public interface Warning extends Comment
{
   ...
   * @see org.ollabaca.on.mm.task.TaskPackage#getWarning_Mitigation()
  ...
  /**
   * Sets the value of the '{@link org.ollabaca.on.mm.task.Warning#getMitigation <em>Mitigation</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
