...
public class GtbrSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GtbrPackage.CLEARING: {
				Clearing clearing = (Clearing)theEObject;
				T result = caseClearing(clearing);
				if (result == null) result = caseAccountingElement(clearing);
				if (result == null) result = casePackageableElement(clearing);
				if (result == null) result = caseNamedElement(clearing);
				if (result == null) result = caseParameterableElement(clearing);
				if (result == null) result = caseElement(clearing);
				if (result == null) result = caseEModelElement(clearing);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Clearing</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Clearing</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseClearing(Clearing object) {
		return null;
	}
