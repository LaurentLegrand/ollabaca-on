...
public class AccountImpl extends NamedElementImpl implements Account {
	...
	public double getBalance() {
		...
		final Function1<Record, Date> _function = new Function1<Record, Date>() {
			public Date apply(final Record it) {
				...
				boolean _equals = Objects.equal(_date, null);
				if (_equals) {
					return new Date();
				}
				else {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == PackageableElement.class) {
			switch (baseOperationID) {
				case UMLPackage.PACKAGEABLE_ELEMENT___VALIDATE_NAMESPACE_NEEDS_VISIBILITY__DIAGNOSTICCHAIN_MAP: return GtbrPackage.ACCOUNT___VALIDATE_NAMESPACE_NEEDS_VISIBILITY__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
		if (baseClass == AccountingElement.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case GtbrPackage.ACCOUNT___VALIDATE_NAMESPACE_NEEDS_VISIBILITY__DIAGNOSTICCHAIN_MAP:
