...
import org.ollabaca.on.mm.gtbr.Clearing;
...
public class GtbrPackageImpl extends EPackageImpl implements GtbrPackage {
	 ...
	 * @generated
	 */
	private EClass clearingEClass = null;
	 ...
	 * @generated
	 */
	public EClass getClearing() {
		return clearingEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getClearing_Records() {
		return (EReference)clearingEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		clearingEClass = createEClass(CLEARING);
		createEReference(clearingEClass, CLEARING__RECORDS);
	...
	public void initializePackageContents() {
		...
		clearingEClass.getESuperTypes().add(this.getAccountingElement());
		...
		initEClass(clearingEClass, Clearing.class, "Clearing", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClearing_Records(), this.getRecord(), null, "records", null, 2, 2, Clearing.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
