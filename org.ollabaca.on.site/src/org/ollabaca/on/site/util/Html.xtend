...
public class Html {
	...
	def static CharSequence span(String self) {
	...
	static def <E> CharSequence tag(E self, String name, 
		List<Attr<E>> attributes, 
		List<Content<E>> contents) {
		'''
	...
	static def <E> CharSequence dl(Iterable<? extends E> self, List<Attr<Iterable<? extends E>>> attributes, Content<E> term, Content<E> definition) {
		if (self.empty) {
			return ""
		}
	...
	static def <E> CharSequence ol(Iterable<? extends E> self, List<Attr<Iterable<? extends E>>> attributes, Content<E> item) {
	...
	static def <E> CharSequence ul(Iterable<? extends E> self, List<Attr<Iterable<? extends E>>> attributes, Content<E> item) {
		list(self, "ul", attributes, item)
	}
	
	static def <E> CharSequence list(Iterable<? extends E> self, String name, List<Attr<Iterable<? extends E>>> attributes, Content<E> item) {
		if (self.empty) {
			return ""
		}
	...
	static def <E> CharSequence table(Iterable<? extends E> list, List<Attr<Iterable<? extends E>>> attributes, List<Column<E>> columns) {
			'''
			<table class="table">
			<thead>
				<tr>
	...
	def static dispatch String href(Tag self, String path) {
		'''/site/«path»/«site.name»/tags/«self.name»'''
	}
	...
	def static dispatch CharSequence link(EObject self) {
		link(self.topic_EObject)
	}
	
	def static dispatch CharSequence link(Void self) {
		"null"
	}
	
	def static dispatch CharSequence link(Site self) {
		'''<a href="«href(self)»">«self.name»</a>'''
	}
	
	def static dispatch CharSequence link(Topic self) {
		'''<a href="«href(self)»">«self.title»</a>'''
	}
	
	def static dispatch CharSequence link(EClass self) {
		'''<a href="«href(self)»">«self.name»</a>'''		
	}

	def static dispatch CharSequence link(Tag self) {
		'''<a href="«href(self)»">«self.name»</a>'''		
	}
