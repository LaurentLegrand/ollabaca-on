		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getInstanceAccess().getNameAssignment_7_0(), "rule__Instance__NameAssignment_7_0");
					put(grammarAccess.getInstanceAccess().getTypeAssignment_9(), "rule__Instance__TypeAssignment_9");
					put(grammarAccess.getInstanceAccess().getSlotsAssignment_11(), "rule__Instance__SlotsAssignment_11");
