		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUnitAccess().getContainerAssignment_1(), "rule__Unit__ContainerAssignment_1");
					put(grammarAccess.getUnitAccess().getInstancesAssignment_2(), "rule__Unit__InstancesAssignment_2");
