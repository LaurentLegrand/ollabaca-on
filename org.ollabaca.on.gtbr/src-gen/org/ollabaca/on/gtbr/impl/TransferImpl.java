 ...
 * <ul>
 *   <li>{@link org.ollabaca.on.gtbr.impl.TransferImpl#getDate <em>Date</em>}</li>
 *   <li>{@link org.ollabaca.on.gtbr.impl.TransferImpl#getAmount <em>Amount</em>}</li>
 *   <li>{@link org.ollabaca.on.gtbr.impl.TransferImpl#getFrom <em>From</em>}</li>
 *   <li>{@link org.ollabaca.on.gtbr.impl.TransferImpl#getTo <em>To</em>}</li>
 *   <li>{@link org.ollabaca.on.gtbr.impl.TransferImpl#getDebit <em>Debit</em>}</li>
 *   <li>{@link org.ollabaca.on.gtbr.impl.TransferImpl#getCredit <em>Credit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
